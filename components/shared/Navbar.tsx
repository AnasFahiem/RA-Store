            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between h-16 items-center">
                    ...
                    <div className="flex-shrink-0 flex items-center">
                        <Link href="/" className="flex items-center gap-2 group">
                            <div className="relative w-10 h-10">
                                <Image src="/logo.png" alt="RA Store Logo" fill className="object-contain" />
                            </div>
                            <span className="text-2xl font-bold font-heading uppercase tracking-tighter group-hover:text-accent transition-colors hidden sm:block">
                                RA STORE
                            </span>
                        </Link>
                    </div>
                    ...
                    <div className="hidden md:ml-6 md:flex md:space-x-8">
                        ...
                        {role === 'admin' && (
                            <Link href="/admin/dashboard" className="text-accent hover:text-white px-3 py-2 text-sm font-bold transition-colors uppercase tracking-wide">
                                {t('adminPanel')}
                            </Link>
                        )}
                    </div>
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <Link href="/cart" className="group -m-2 flex items-center p-2 text-gray-400 hover:text-accent transition-colors relative">
                        ...
                        <div className="md:hidden">
                            <button className="text-gray-500 hover:text-accent p-2">
