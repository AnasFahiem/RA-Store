...
function generateEmailHtml(title: string, orderId: string, message: string, detailsHtml: string, actionHtml: string = '') {
    return `
    <!DOCTYPE html>
    <html>
    <head>
    ...
    <body style="background-color: #000; color: #fff;">
        <div class="container">
            <div class="header">
                <h1>${title}</h1>
                <p style="color: #888; font-size: 0.9em;">Order #${orderId.slice(0, 8)}</p>
            </div>
